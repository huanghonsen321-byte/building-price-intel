...
from app.services.crawl_service import build_crawl_dashboard_summary, list_crawl_tasks, run_mock_crawl, run_public_crawl
...
def get_crawl_dashboard(db: Session = Depends(get_db)):
    return build_crawl_dashboard_summary(db)
